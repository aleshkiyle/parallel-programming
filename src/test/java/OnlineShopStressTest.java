...
public class OnlineShopStressTest {
    ...
    public void buyStressTest() throws ExecutionException, InterruptedException {
        ...
        List<Runnable> tasks = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            tasks.add(new BuyRunnable(onlineShop,
                    "Customer " + i, goodName, 10, 10));
        }
        ...
        onlineShop.getCustomers().values().
                forEach(customer -> assertEquals(800.0, customer.getBalance()));
    }
